...
Feel free to head on over to the [end user documentation](#end-user-docs) to learn how to use the plugin!


# Getting Started as a Developer on the Plugin
...
I am using a mac for development. Here are the commands I ran to get the source code loaded onto my computer with all dependencies installed and PyCharm setup to allow me to develop this plugin. **If you are working on windows** then there are alternatives to some commands, and these are found [here](https://github.com/Ultimaker/Cura/wiki/Running-Cura-from-Source)DefaultCura.png 
where I got the commands in the first place. 
