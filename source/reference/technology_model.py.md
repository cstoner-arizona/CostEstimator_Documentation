...
self.\_related_materials: dict\[str, list\[str]] = Holds the material types : list of materials section that can be found in the meta data key in the [json files](#JsonFilesInfo)
